...
public class ChangePassWordActivityFirstTime extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.change_pass_first_time);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.submit3) {
			...
			if (newpass.equals(confpass)) {
				...
				Toast.makeText(context, "Password succesfully changed",
